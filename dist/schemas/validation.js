...
exports.createOrderSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        paymentInfo: zod_1.z.object({
            method: zod_1.z.enum(['credit_card', 'debit_card', 'paypal', 'stripe', 'apple_pay', 'google_pay', 'bank_transfer', 'cash_on_delivery']),
            transactionId: zod_1.z.string().min(1, 'Transaction ID is required'),
            cardLastFour: zod_1.z.string().length(4).optional(),
